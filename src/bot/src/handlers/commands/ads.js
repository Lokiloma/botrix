...
module.exports = {
  ...
  async execute(message, args) {
    try{
        ...
        .setDescription(`Tumull allows you to advertise in our server for free in ${chan}, but you can always list your server on our site [here](https://tumull.casino/servers).\n\n**Server Rule :**\`\`\`fix\nIf you want to advertise, send your ad in #│self-promo. [ Remember if it's a botlist promo or any kind of NSFW promo. Our staff team has the right to remove it. ]\`\`\``)
